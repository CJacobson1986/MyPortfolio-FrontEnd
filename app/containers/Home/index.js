    ...
    return (
      <div className="container">
        ...
        <Slider />
          ...
          <div className='VerticalOverlay'><header className='Author'>Christopher Jacobson</header><div className="siteDesc">I created this web page for the purpose of showing a simple clean presentation of a web page. I utilized full stack development creating the front-end, back-end, and database utilized in this site. I hope you enjoy.</div></div>
      </div>
    );
  }
}
